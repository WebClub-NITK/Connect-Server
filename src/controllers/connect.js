...
@response - {user object, signed access token, username, type of user}
*/
...
@response - {userId, signed access token, username, type of user}
*/
...
@params - {username, password}
@response - {anonymousUserId, signed access token, username, type of user}
*/
